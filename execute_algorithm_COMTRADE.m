...
function [Phasor,sampling_number_beyond] = execute_algorithm_COMTRADE(test_signal,Alg_selec,num_alg_select,tag)
...
for num=1:num_alg_select
    ...
    [Phasor{num,1},Phasor{num,2},sampling_number_beyond{num,1}]=eval([Alg_selec{num},'(test_signal,tag);']);
